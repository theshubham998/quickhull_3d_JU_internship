#ifndef QUICKHULL3D_H_INCLUDED
#define QUICKHULL3D_H_INCLUDED
...
public:
     ...
     */
    QuickHull3D(vector<double> coords, int len);
     ...
     */
    virtual void setPoints(vector<double> coords, int nump);
     ...
     * @param nump number of coordinated (3*number of points)
     */
    virtual void build(vector<double> coords, int nump);
    ...
    void setHull(vector<double> coords, int nump, vector<vector<int> > faceIndices, int numf);
